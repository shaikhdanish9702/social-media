...
const Post = ({data}) => {
  ...
  return (
    <div className="Post">
      ...
      <img className="post-Profile-img" src={data.profilePicture
              ?  user.profilePicture
        ...
        {/* <UilPen onClick={()=>setEditOption(prev=>!prev)} className='post-edit' />
        <EditPost editOption={editOption} data={data} setEditOption={setEditOption}/> */}
      </div>
